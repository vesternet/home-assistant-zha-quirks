"""Vesternet VES-ZB-REM-013 12 Button Remote Control."""
...
class VesternetVESZBREM01312ButtonRemoteControl(CustomDevice):
    """Vesternet VES-ZB-REM-013 12 Button Remote Control."""

    signature = {
        MODELS_INFO: [("Sunricher", "ZGRC-KEY-013")],
        ENDPOINTS: {
            1: {
    ...
    device_automation_triggers = {
        ...
        (SHORT_PRESS, "Group 3 On"): {
            COMMAND: COMMAND_ON,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 6,
        },
        (LONG_PRESS, "Group 3 On"): {
            COMMAND: COMMAND_MOVE_ON_OFF,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 0, "rate": 50},
        },
        (ALT_LONG_PRESS, "Group 3 On"): {
            COMMAND: COMMAND_MOVE,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 0, "rate": 50},
        },
        (ALT_LONG_RELEASE, "Group 3"): {
            COMMAND: COMMAND_STOP,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
        },
        (LONG_RELEASE, "Group 3"): {
            COMMAND: COMMAND_STOP_ON_OFF,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
        },
        (SHORT_PRESS, "Group 3 Off"): {
            COMMAND: COMMAND_OFF,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 6,
        },
        (LONG_PRESS, "Group 3 Off"): {
            COMMAND: COMMAND_MOVE_ON_OFF,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 1, "rate": 50},
        },
        (ALT_LONG_PRESS, "Group 3 Off"): {
            COMMAND: COMMAND_MOVE,
            ENDPOINT_ID: 3,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 1, "rate": 50, "options_mask": 0, "options_override": 0},
        },
        (SHORT_PRESS, "Group 4 On"): {
            COMMAND: COMMAND_ON,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 6,
        },
        (LONG_PRESS, "Group 4 On"): {
            COMMAND: COMMAND_MOVE_ON_OFF,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 0, "rate": 50},
        },
        (ALT_LONG_PRESS, "Group 4 On"): {
            COMMAND: COMMAND_MOVE,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 0, "rate": 50},
        },
        (ALT_LONG_RELEASE, "Group 4"): {
            COMMAND: COMMAND_STOP,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
        },
        (LONG_RELEASE, "Group 4"): {
            COMMAND: COMMAND_STOP_ON_OFF,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
        },
        (SHORT_PRESS, "Group 4 Off"): {
            COMMAND: COMMAND_OFF,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 6,
        },
        (LONG_PRESS, "Group 4 Off"): {
            COMMAND: COMMAND_MOVE_ON_OFF,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 1, "rate": 50},
        },
        (ALT_LONG_PRESS, "Group 4 Off"): {
            COMMAND: COMMAND_MOVE,
            ENDPOINT_ID: 4,
            CLUSTER_ID: 8,
            PARAMS: {"move_mode": 1, "rate": 50, "options_mask": 0, "options_override": 0},
        ...
        (SHORT_PRESS, "Scene 1"): {
            ...
            ENDPOINT_ID: 1,
            CLUSTER_ID: 5,
            PARAMS: {"group_id": 0x0000, "scene_id": 1, "transition_time": 0},
        },
        (SHORT_PRESS, "Scene 2"): {
            COMMAND: COMMAND_RECALL,
            ENDPOINT_ID: 1,
            CLUSTER_ID: 5,
            PARAMS: {"group_id": 0x0000, "scene_id": 2, "transition_time": 0},
        },
    }