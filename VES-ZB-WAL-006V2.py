"""Vesternet VES-ZB-WAL-006 2 Button Wall Controller."""
...
class VesternetVESZBWAL0062ButtonWallController(CustomDevice):
    """Vesternet VES-ZB-WAL-006 2 Button Wall Controller."""

    signature = {
        MODELS_INFO: [("Sunricher", "ZG2833K2_EU07"), ("Sunricher", "ZGRC-KEY-007")],
        ENDPOINTS: {
            1: {
